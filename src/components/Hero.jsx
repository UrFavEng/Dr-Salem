...
const Hero = () => {
  return (
    <div className=" flex flex-col md:flex-row-reverse  justify-between items-center  lg:items-end py-[30px] md:py-[60px] xl:py-[70px] md:gap-2 lg:gap-8 mt-[40px]">
      ...
      <div className="pt-[20px] md:py-[0px] md:w-[50%] lg:w-auto lg:flex-[10] xl:flex-[10] flex flex-row-reverse  lg:justify-end  md:gap-3 lg:gap-8 mb-[25px]">
        <div className="lg:flex lg:flex-col lg:justify-center xl:block">
          <h1 className=" text-[41px] md:text-[35px] md:mt-[15px] lg:mt-[0px] lg:text-[60px] xl:text-[78px] font-bold md:tracking-[1px] lg:tracking-[3px] text-[#035356]">
            Salem Elzeny
          </h1>
          <h4 className=" text-[22px] md:text-[22px]   lg:text-[28px] capitalize text-[#545454] pl-[8px] md:pl-[8px] font-medium tracking-[1px] sm:mt-[-10px] md:mt-[-8px] lg:mt-[-12px]  xl:mt-[-25px] textShadowSec flex flex-row items-center gap-2">
            Physiotherapist{" "}
            <FaUserDoctor className="text-[#3d7d80] text-[22px]" />
          </h4>
          <p className="pl-[8px] md:pl-[8px]  md:leading-[20px]  mt-[15px]  md:mt-[8px] lg:leading-[25px]  text-[#6e6e6e] md:text-[14px] lg:text-[16px] font-medium lg:mt-[25px] tracking-[0.75px]">
